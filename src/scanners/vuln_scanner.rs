...
pub async fn scan(target: &str, output_path: Option<&Path>, verbose: bool) -> FortiCoreResult<()> {
    ...
    let vuln_scan_ports = [
        21, 22, 23, 25, 53, 80, 111, 139, 443, 445, 1433, 1521, 2049, 3306, 3389, 5432, 5900, 6000, 6543,
        6667, 8080, 8443, 9100, 9099, 27017,135, 512, 513, 514, 1099, 1524, 2121, 3632, 5432, 5900, 6000, 6697, 8009, 8180, 8787, 10000,
    ];
